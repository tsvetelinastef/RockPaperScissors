...
### `#RRGGBB`Rock-Paper-Scissors`#RRGGBB`  is a simple two player game. Where you and your oponent(the computer) simultaneously choose one of the following three options: "rock", "paper"or "scissors". The rules are as follows:
